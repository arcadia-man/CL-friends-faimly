...
const Friends = () => {
  ...
  return (
    <div style={{ backgroundColor: "rgba(0, 0, 0, 0.05)", minHeight: "100vh" }} className='pb-5'>
      <MDBContainer>
        <MDBBtnGroup className='mt-5 p-4' style={{ width: "100%", color: "black" }}>
          <MDBBtn className='p-3' style={friendSatus.isMember ? { backgroundColor: '#771a7e', color: "white" } : { backgroundColor: '#f3edf4', color: "black" }} onClick={freindShow}> Friends </MDBBtn>
